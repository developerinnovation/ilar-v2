...
namespace Drupal\ngt_evaluation\Plugin\Block;

use Drupal\Component\Transliteration\TransliterationInterface;
use Drupal\Core\Form\FormStateInterface;
use Drupal\Core\Session\AccountInterface;
use Drupal\ngt_evaluation\Plugin\Config\Block\EvaluationBlockClass;
...
/**
 * Provides a 'EvaluationBlock' block.
 *
 * @Block(
 *  id = "ngt_evaluation_block",
 *  admin_label = @Translation("Ngt Evaluations"),
 * )
 */
class EvaluationBlock extends CardBlockBase implements ContainerFactoryPluginInterface{
    /**
     * @var \Drupal\ngt_evaluation\Plugin\Config\Block\EvaluationBlockClass
     */
     ...
     * @param \Drupal\ngt_evaluation\Plugin\Config\Block\EvaluationBlockClass $configurationInstance
     */
    public function __construct(array $configuration, $plugin_id, $plugin_definition, EvaluationBlockClass $configurationInstance) {
    ...
    public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
        return new static(
            ...
            $plugin_id,
            $plugin_definition,
            $container->get('ngt_evaluation.evaluation_block')
        );
    }
