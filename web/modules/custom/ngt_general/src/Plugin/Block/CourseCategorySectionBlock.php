...
use Drupal\ngt_general\Plugin\Config\Block\CourseCategorySectionBlockClass;
use Symfony\Component\DependencyInjection\ContainerInterface;
use Drupal\Core\Access\AccessResult;

/**
 * Provides a 'CourseCategorySectionBlock' block.
 *
 * @Block(
 *  id = "ngt_general_course_category_section",
 *  admin_label = @Translation("Ngt general Curso por categorías para sección"),
 * )
 */
class CourseCategorySectionBlock extends CardBlockBase implements ContainerFactoryPluginInterface{
    /**
     * @var \Drupal\ngt_general\Plugin\Config\Block\CourseCategorySectionBlockClass
     */
     ...
     * @param \Drupal\ngt_general\Plugin\Config\Block\CourseCategorySectionBlockClass $configurationInstance
     */
    public function __construct(array $configuration, $plugin_id, $plugin_definition, CourseCategorySectionBlockClass $configurationInstance) {
    ...
    public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
        return new static(
            ...
            $plugin_id,
            $plugin_definition,
            $container->get('ngt_general.course_category_section')
        );
    }
