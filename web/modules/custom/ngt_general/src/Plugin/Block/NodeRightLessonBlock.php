...
use Drupal\ngt_general\Plugin\Config\Block\NodeRightLessonBlockClass;
...
/**
 * Provides a 'NodeRightLessonBlock' block.
 *
 * @Block(
 *  id = "ngt_general_node_right_lesson",
 *  admin_label = @Translation("Ngt general Node lesson right"),
 * )
 */
class NodeRightLessonBlock extends CardBlockBase implements ContainerFactoryPluginInterface{
    /**
     * @var \Drupal\ngt_general\Plugin\Config\Block\NodeRightLessonBlockClass
     */
     ...
     * @param \Drupal\ngt_general\Plugin\Config\Block\NodeRightLessonBlockClass $configurationInstance
     */
    public function __construct(array $configuration, $plugin_id, $plugin_definition, NodeRightLessonBlockClass $configurationInstance) {
    ...
    public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
        return new static(
            ...
            $plugin_id,
            $plugin_definition,
            $container->get('ngt_general.node_right_lesson')
        );
    }
