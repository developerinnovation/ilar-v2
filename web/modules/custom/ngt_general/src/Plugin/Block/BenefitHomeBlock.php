...
use Drupal\ngt_general\Plugin\Config\Block\BenefitHomeBlockClass;
 ...
 *
 * @Block(
 *  id = "ngt_general_benefit_home",
 *  admin_label = @Translation("Ngt general Beneficio en Home"),
 * )
 */
class BenefitHomeBlock extends BlockBase implements ContainerFactoryPluginInterface{
     ...
     * @param \Drupal\ngt_general\Plugin\Config\Block\BenefitHomeBlockClass $configurationInstance
     */
    ...
    public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
        return new static(
            ...
            $plugin_id,
            $plugin_definition,
            $container->get('ngt_general.benefit_home')
        );
    }
