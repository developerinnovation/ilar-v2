...
use Drupal\ngt_general\Plugin\Config\Block\NodeMoreCourseBlockClass;
 ...
 *
 * @Block(
 *  id = "ngt_general_node_more_course",
 *  admin_label = @Translation("Ngt general Node course more"),
 * )
 */
class NodeMoreCourseBlock extends BlockBase implements ContainerFactoryPluginInterface{
     ...
     * @param \Drupal\ngt_general\Plugin\Config\Block\NodeMoreCourseBlockClass $configurationInstance
     */
    ...
    public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
        return new static(
            ...
            $plugin_id,
            $plugin_definition,
            $container->get('ngt_general.node_more_course')
        );
    }
