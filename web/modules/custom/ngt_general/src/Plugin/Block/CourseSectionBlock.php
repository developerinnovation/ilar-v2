...
use Drupal\ngt_general\Plugin\Config\Block\CourseSectionBlockClass;
use Symfony\Component\DependencyInjection\ContainerInterface;
use Drupal\Core\Access\AccessResult;

/**
 * Provides a 'CourseSectionBlock' block.
 *
 * @Block(
 *  id = "ngt_general_course_section",
 *  admin_label = @Translation("Ngt general sección de cursos"),
 * )
 */
class CourseSectionBlock extends CardBlockBase implements ContainerFactoryPluginInterface{
    /**
     * @var \Drupal\ngt_general\Plugin\Config\Block\CourseSectionBlockClass
     */
     ...
     * @param \Drupal\ngt_general\Plugin\Config\Block\CourseSectionBlockClass $configurationInstance
     */
    public function __construct(array $configuration, $plugin_id, $plugin_definition, CourseSectionBlockClass $configurationInstance) {
    ...
    public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
        return new static(
            ...
            $plugin_id,
            $plugin_definition,
            $container->get('ngt_general.course_section')
        );
    }
