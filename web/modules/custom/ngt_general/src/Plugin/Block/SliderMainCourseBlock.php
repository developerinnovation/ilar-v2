...
use Drupal\ngt_general\Plugin\Config\Block\SliderMainCourseBlockClass;
...
/**
 * Provides a 'SliderMainCourseBlock' block.
 *
 * @Block(
 *  id = "ngt_general_slider_course",
 *  admin_label = @Translation("Ngt general slider cursos en sección"),
 * )
 */
class SliderMainCourseBlock extends BlockBase implements ContainerFactoryPluginInterface{
    /**
     * @var \Drupal\ngt_general\Plugin\Config\Block\SliderMainCourseBlockClass
     */
     ...
     * @param \Drupal\ngt_general\Plugin\Config\Block\SliderMainCourseBlockClass $configurationInstance
     */
    public function __construct(array $configuration, $plugin_id, $plugin_definition, SliderMainCourseBlockClass $configurationInstance) {
    ...
    public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
        return new static(
            ...
            $plugin_id,
            $plugin_definition,
            $container->get('ngt_general.slider_course')
        );
    }
