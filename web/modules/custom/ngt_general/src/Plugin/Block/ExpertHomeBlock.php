...
use Drupal\ngt_general\Plugin\Config\Block\ExpertHomeBlockClass;
...
/**
 * Provides a 'ExpertHomeBlock' block.
 *
 * @Block(
 *  id = "ngt_general_expert_home",
 *  admin_label = @Translation("Ngt general Expertos en Home"),
 * )
 */
class ExpertHomeBlock extends BlockBase implements ContainerFactoryPluginInterface{
    /**
     * @var \Drupal\ngt_general\Plugin\Config\Block\ExpertHomeBlockClass
     */
     ...
     * @param \Drupal\ngt_general\Plugin\Config\Block\ExpertHomeBlockClass $configurationInstance
     */
    public function __construct(array $configuration, $plugin_id, $plugin_definition, ExpertHomeBlockClass $configurationInstance) {
    ...
    public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
        return new static(
            ...
            $plugin_id,
            $plugin_definition,
            $container->get('ngt_general.expert_home')
        );
    }
