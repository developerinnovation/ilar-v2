...
use Drupal\ngt_general\Plugin\Config\Block\ContentDestBlockClass;
 ...
 *
 * @Block(
 *  id = "ngt_general_contenido_destacado",
 *  admin_label = @Translation("Ngt general Contenido destacado"),
 * )
 */
class ContentDestBlock extends BlockBase implements ContainerFactoryPluginInterface{
     ...
     * @param \Drupal\ngt_general\Plugin\Config\Block\ContentDestBlockClass $configurationInstance
     */
    ...
    public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
        return new static(
            ...
            $plugin_id,
            $plugin_definition,
            $container->get('ngt_general.content_dest')
        );
    }
