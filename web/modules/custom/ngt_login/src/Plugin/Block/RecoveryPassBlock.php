...
use Drupal\ngt_login\Plugin\Config\Block\RecoveryPassBlockClass;
use Symfony\Component\DependencyInjection\ContainerInterface;
use Drupal\Core\Access\AccessResult;

/**
 * Provides a 'RecoveryPassBlock' block.
 *
 * @Block(
 *  id = "ngt_login_recovery_pass",
 *  admin_label = @Translation("NGT Recovery pass"),
 * )
 */
class RecoveryPassBlock extends CardBlockBase implements ContainerFactoryPluginInterface{
    /**
     * @var \Drupal\ngt_login\Plugin\Config\Block\RecoveryPassBlockClass
     */
     ...
     * @param \Drupal\ngt_login\Plugin\Config\Block\RecoveryPassBlockClass $configurationInstance
     */
    public function __construct(array $configuration, $plugin_id, $plugin_definition, RecoveryPassBlockClass $configurationInstance) {
    ...
    public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
        return new static(
            ...
            $plugin_id,
            $plugin_definition,
            $container->get('ngt_login.recovery_pass')
        );
    }
