...
use Drupal\ngt_login\Plugin\Config\Block\EditUserBlockClass;
use Symfony\Component\DependencyInjection\ContainerInterface;
use Drupal\Core\Access\AccessResult;

/**
 * Provides a 'EditUserBlock' block.
 *
 * @Block(
 *  id = "ngt_login_edit_user",
 *  admin_label = @Translation("NGT edit user"),
 * )
 */
class EditUserBlock extends CardBlockBase implements ContainerFactoryPluginInterface{
    /**
     * @var \Drupal\ngt_login\Plugin\Config\Block\EditUserBlockClass
     */
     ...
     * @param \Drupal\ngt_login\Plugin\Config\Block\EditUserBlockClass $configurationInstance
     */
    public function __construct(array $configuration, $plugin_id, $plugin_definition, EditUserBlockClass $configurationInstance) {
    ...
    public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
        return new static(
            ...
            $plugin_id,
            $plugin_definition,
            $container->get('ngt_login.edit_user')
        );
    }
