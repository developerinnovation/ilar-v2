...
use Drupal\ngt_login\Plugin\Config\Block\RegisterUserBlockClass;
use Symfony\Component\DependencyInjection\ContainerInterface;
use Drupal\Core\Access\AccessResult;

/**
 * Provides a 'RegisterUserBlock' block.
 *
 * @Block(
 *  id = "ngt_login_register_user",
 *  admin_label = @Translation("NGT Register user"),
 * )
 */
class RegisterUserBlock extends CardBlockBase implements ContainerFactoryPluginInterface{
    /**
     * @var \Drupal\ngt_login\Plugin\Config\Block\RegisterUserBlockClass
     */
     ...
     * @param \Drupal\ngt_login\Plugin\Config\Block\RegisterUserBlockClass $configurationInstance
     */
    public function __construct(array $configuration, $plugin_id, $plugin_definition, RegisterUserBlockClass $configurationInstance) {
    ...
    public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
        return new static(
            ...
            $plugin_id,
            $plugin_definition,
            $container->get('ngt_login.register_user')
        );
    }
